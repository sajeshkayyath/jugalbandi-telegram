...
async def query_handler(update: Update, context: CallbackContext):
    ...
    mergedQuery="fetch data in bullets format without new line characters for " + query + " with fields only content, content type, language, source, links each as bullet point?"
